...
namespace UseCases.Services.Tests
{
    ...
    { 
        ...
        {
            if (MockingContextTests.values.send_request_to_instagram_service) {
                MockingContextTests.DeleteAllSessions();
                User userCache = MockingContextTests.CreateUser();
        ...
        public void RecoverySession()
        {
            if (MockingContextTests.values.send_request_to_instagram_service) {
                MockingContextTests.DeleteAllSessions();
                User userCache = MockingContextTests.CreateUser();
                IGAccount account = MockingContextTests.CreateSession(userCache.userId);
        ...
        {
            User user = MockingContextTests.CreateUser();
            IGAccount cache = MockingContextTests.CreateSession(user.userId);
            Session session = new Session();
