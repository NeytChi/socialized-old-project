...
{
    [TestFixture]
    public static class TestMockingContext
    {
        ...
        public static AdminCache GetAdminCache()
        {
            AdminCache cache = new AdminCache() {
                admin_email = TestMockingContext.values.admin_email,
                admin_password = TestMockingContext.values.admin_password,
                admin_fullname = TestMockingContext.values.admin_fullname        
            };
        ...
        public static BusinessAccount BusinessAccountEnviroment()
        {
            ...
            return TestMockingContext.CreateBusinessAccount(account);
        }
        ...
        public static BlogPost CreateBlogPost(int adminId)
        {
            BlogPost post = new BlogPost() {
                adminId = adminId,
                postSubject = TestMockingContext.values.post_subject,
                postHtmlText = TestMockingContext.values.post_htmltext,
                postLanguage = TestMockingContext.values.post_language,
                createdAt = DateTime.Now 
            };
        ...
        public static Appeal CreateAppeal(int userId)
        {
            Appeal appeal = new Appeal() {
                userId = userId,
                appealSubject = TestMockingContext.values.post_subject,
                appealState = 1,
                createdAt = DateTime.Now,
        ...
        public static AppealMessage CreateAppealMessage(int appealId)
        {
            AppealMessage message = new AppealMessage() {
                appealId = appealId,
                messageText = TestMockingContext.values.post_htmltext,
                createdAt = DateTime.Now,
            };
