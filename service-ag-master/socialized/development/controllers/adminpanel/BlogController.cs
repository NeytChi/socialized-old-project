...
namespace Controllers
{
    ...
    public class BlogController : ControllerBase
    {
        ...
        {
            this.blogs = new Blogs(log, context);
        }
        ...
        public ActionResult<dynamic> CreatePost(BlogCache cache)
        {
            ...
            cache.admin_id = Int32.Parse(this.HttpContext?.User.Claims.FirstOrDefault().Value ?? 
        ...
        public ActionResult<dynamic> GetBlog([FromQuery] int postId)
        {
            ...
            if (post != null)
                return new { success = true, data = new { post = post } };
            return Return500Error(message);
        }
        [HttpPost]
        [Authorize]
