...
{
    [TestFixture]
    public class TestAutoPostingManager
    {
        ...
        public TestAutoPostingManager()
        {
            ...
            user = TestMockingContext.CreateUser();
       ...
       [Test]
        ...
        {
            Category category = TestMockingContext.CreateCategory(account.accountId);
