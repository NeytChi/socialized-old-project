...
namespace InstagramApiSharp.API
{
    ...
    public class InstagramApi
    {
        ...
        public static InstagramApi CreateInstance(InstaApiVersionType apiVersionType)
        {
            if (instance == null)
            {
                instance = new InstagramApi(apiVersionType);
            }
            return instance;
        }
        ...
        {
            if (instance == null)
                instance = new InstagramApi(InstaApiVersionType.Version86);
            return instance;
        }
      ...
      //  private IAccountProcessor _accountProcessor;
       ...
       // IShoppingProcessor _shoppingProcessor;
        private InstagramApi(InstaApiVersionType apiVersionType)
        {
            ...
            this.hashtag = new HashtagProcessor(log);
            this.users = new UserProcessor(log);
            this.location = new LocationProcessor(log);
